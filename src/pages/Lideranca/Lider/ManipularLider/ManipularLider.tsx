...
import { Lider, LiderCreateOrUpdate , createOrUpdateLider, getLideres } from "../../../../services/liderService";
...
const ManipularLider: React.FC = () => {
    ...
    const initialValues: LiderCreateOrUpdate = {
        id: "",
        pessoaId: "",
        celulas: []
    };
    ...
    const onSubmit = async (values: LiderCreateOrUpdate, { resetForm }: { resetForm: () => void }) => {
        try {
            ...
            {({ errors, touched }) => (
                <>
                    ...
                    <MultipleDatalist
                        ...
                        selectedCelulas={selectedCelulas}
                        setSelectedCelulas={setSelectedCelulas}
                    />
